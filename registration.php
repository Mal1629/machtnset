...
<div style="width:auto; height:50px; margin:auto; float:none; margin-bottom:10px; text-align:center; clear:both;">
...
<div class="phpkida-main">
	<h2>Register Now</h2>
		<form action="#" method="post">
			<input type="text" class="ggg" name="Nickname" placeholder="Nickname" required="">
            <input type="date" class="ggg" name="birthday" placeholder="birthday" required="">
            ...
            <div class="genders">
             ...
             <input type="radio" id="gender"  name="gender" value ="female">
                 ...
                 <label for="non">non-binaire </label><br>
             </div>
